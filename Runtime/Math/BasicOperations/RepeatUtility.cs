...
{
    public static class RepeatUtility
    {
        #region Repeat
        ...
        {
            return (num - min).Modulo(max - min + 1) + min;
        }
        ...
        {
            return (num - min).Modulo(max - min) + min;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2Int Repeat(this Vector2Int vector, Vector2Int min, Vector2Int max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector3Int Repeat(this Vector3Int vector, Vector3Int min, Vector3Int max)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float PingPong(this float num, float length)
        {
            return length - (num.Repeat(length + length) - length).Abs();
        }
