...
namespace VMFramework.Core
{
    public static class ComparableUtility
    {
        ...
        {
            return list.GetSizeRange().SelectMaxGroup(index => selector(list[index]));
        }
        ...
        public static IEnumerable<int> GetIndicesOfMinValues<TItem, TValue>(this IList<TItem> list,
            ...
            where TValue : IComparable
        {
            return list.GetSizeRange().SelectMinGroup(index => selector(list[index]));
        }
        ...
        public static IEnumerable<int> GetIndicesOfMaxValues<TValue>(this IList<TValue> list)
            where TValue : IComparable
        {
            return list.GetSizeRange().SelectMaxGroup(index => list[index]);
        }
        ...
        public static IEnumerable<int> GetIndicesOfMinValues<TValue>(this IList<TValue> list)
            where TValue : IComparable
        {
            return list.GetSizeRange().SelectMinGroup(index => list[index]);
        }
