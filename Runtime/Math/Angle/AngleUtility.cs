...
namespace VMFramework.Core
{
    public static class AngleUtility
    {
        ...
        /// <summary>
        /// 从向量<paramref name="vector"/>到向量<see cref="Vector2.right"/>即(1, 0)的顺时针角度
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float ClockwiseAngle(this Vector2 vector)
        {
            return vector.ClockwiseAngle(Vector2.right);
        }

        /// <summary>
        /// 从向量<paramref name="from"/>到向量<paramref name="to"/>的顺时针角度
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// 从<paramref name="vector"/>到向量<see cref="Vector2.right"/>即(1, 0)的逆时针角度
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float CounterclockwiseAngle(this Vector2 vector)
        {
            return vector.CounterclockwiseAngle(Vector2.right);
        }
